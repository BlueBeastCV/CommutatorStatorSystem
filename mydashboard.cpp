...
myDashBoard::myDashBoard(QWidget *parent) : QWidget(parent)
{
...
void myDashBoard::setValue(double val)
{
    m_value = val;
}

void myDashBoard::UpdateAngle()
{
    update();
}
...
void myDashBoard::drawCrown(QPainter *painter)
{
    painter->save();
    int radius = 100;
    ...
    painter->setPen(Qt::SolidLine); //边框线无色
...
void myDashBoard::drawScale(QPainter *painter)
{
    painter->save();
...
void myDashBoard::drawScaleNum(QPainter *painter)
{
    painter->save();
...
void myDashBoard::drawTitle(QPainter *painter)
{
    painter->save();
    painter->setPen(m_foreground);
...
void myDashBoard::drawNumericValue(QPainter *painter)
{
